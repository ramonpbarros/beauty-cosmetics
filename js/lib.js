  ...
  var r = function() {
      ...
      return n(e, null, [{
          ...
          value: function(e) {
              ...
              return "POST" !== n.method && "PUT" !== n.method || (n.body = void 0 === i.data ? null : JSON.stringify(i.data)),
              void 0 !== i.cid && (n.headers.X_CID = void 0 === i.cid ? "" : i.cid),
          ...
          value: function(e, t) {
              if (this._isNullOrEmpty(e.shippingMethodId) && this._logOrderErrorData("shippingMethodId field is not valid!"),
              this._isNullOrEmpty(e.productId) && this._logOrderErrorData("productId field is not valid!"),
              this._isNullOrEmpty(e.funnelBoxId))
                  return this._logOrderErrorData("funnelBoxId field is not valid!");
              if (this._isNullOrEmpty(t) && this._logOrderErrorData("paymentType field is not valid!"),
              "paypal" === t.toLowerCase())
                  void 0 === e.payment.paymentProcessorId && (e.payment = {
                  ...
                  if (this._isNullOrEmpty(e.customer.email) && this._logOrderErrorData("customer email field is not valid!"),
                  this._isNullOrEmpty(e.customer.firstName) && this._isNullOrEmpty(e.shippingAddress.firstName) && this._logOrderErrorData("firstname field is not valid!"),
                  this._isNullOrEmpty(e.customer.lastName) && this._isNullOrEmpty(e.shippingAddress.lastName) && this._logOrderErrorData("lastname field is not valid!"),
                  this._isNullOrEmpty(e.payment.name) && this._isNullOrEmpty(e.payment.cardId)) {
                  ...
                  this._isNullOrEmpty(e.payment.creditcard) && this._logOrderErrorData("creditcard field is not valid!"),
                  this._isNullOrEmpty(e.payment.creditCardBrand) && this._logOrderErrorData("creditCardBrand field is not valid!"),
                  this._isNullOrEmpty(e.payment.expiration) && this._logOrderErrorData("expiration field is not valid!"),
                  this._isNullOrEmpty(e.payment.cvv) && this._logOrderErrorData("cvv field is not valid!"),
                  !1 === e.useShippingAddressForBilling && null == e.billingAddress && this._logOrderErrorData("useShippingAddressForBilling equals false and billingAddress object is not valid!"),
                  this._isNullOrEmpty(e.shippingAddress.firstName) && (e.shippingAddress.firstName = e.customer.firstName),
                  this._isNullOrEmpty(e.shippingAddress.lastName) && (e.shippingAddress.lastName = e.customer.lastName),
                  this._isNullOrEmpty(e.shippingAddress.address1) && this._logOrderErrorData("shippingAddres address1 field is not valid!"),
                  this._isNullOrEmpty(e.shippingAddress.city) && this._logOrderErrorData("shippingAddres city field is not valid!"),
                  this._isNullOrEmpty(e.shippingAddress.countryCode) && this._logOrderErrorData("shippingAddres countryCode field is not valid!"),
                  (this._isNullOrEmpty(e.shippingAddress.state) || "N/A" == e.shippingAddress.state || "-" == e.shippingAddress.state) && (e.shippingAddress.state = e.shippingAddress.countryCode),
                  e.useShippingAddressForBilling || (this._isNullOrEmpty(e.billingAddress.firstName) && (e.billingAddress.firstName = e.shippingAddress.firstName),
                  this._isNullOrEmpty(e.billingAddress.lastName) && (e.billingAddress.lastName = e.shippingAddress.lastName),
                  this._isNullOrEmpty(e.billingAddress.address1) && this._logOrderErrorData("billingAddress address1 field is not valid!"),
                  this._isNullOrEmpty(e.billingAddress.city) && this._logOrderErrorData("billingAddress city field is not valid!"),
                  this._isNullOrEmpty(e.billingAddress.countryCode) && this._logOrderErrorData("billingAddress countryCode field is not valid!"),
                  (this._isNullOrEmpty(e.billingAddress.state) || "N/A" == e.billingAddress.state || "-" == e.billingAddress.state) && (e.billingAddress.state = e.billingAddress.countryCode))
              }
              return location.href.indexOf("?") > 0 && (e.payment.callBackParam = encodeURI(location.href.substr(location.href.indexOf("?")))),
              e
          }
      }, {
          ...
          value: function(e, t) {
              ...
              return e.indexOf("?") > 0 ? e += "" !== i ? "&" + i : "" : e += "" !== i ? "?" + i : "",
...
, , function(e, t, i) {
  ...
  var s = function() {
      function e() {
          ...
          this.cid = i,
          this.isTest = n,
          this.baseAPIEndpoint = void 0 !== r ? r : "https://sales-prod.tryemanagecrm.com/api"
      }
      return r(e, [{
          key: "placeOrder",
          ...
          value: function(e, t) {
              if (e && "" !== e.toString().trim()) {
                  ...
                  console.log("Please enter a valid number order!")
          }
      }, {
          ...
          value: function(e, t, i) {
              if (e && "" !== e)
                  if (t && "" !== t) {
                      ...
                      this.isTest && (n.indexOf("?") > 0 ? n += "&isTest=true" : n += "?isTest=true"),
                      a.default.callAjax(n, {
                          cid: this.cid,
                          method: "PUT",
                          data: t
                      }).then(function(e) {
                      ...
                      console.log("Please provide valid post data!");
              else
                  console.log("Please provide valid tracking number!")
          }
      }, {
...
, function(e, t, i) {
  ...
  var s = function() {
      function e() {
          ...
          this.webkey = t,
          this.cid = i,
          this.baseAPIEndpoint = void 0 !== n ? n : "https://websales-api.tryemanagecrm.com/api"
      }
      return r(e, [{
          key: "getUpsells",
          value: function(e) {
...
*/
      ...
      n = function() {
          ...
          ) : h ? ((g = new MessageChannel).port1.onmessage = m,
          w = function() {
          ...
          function O(t, i, n) {
              ...
              I.error = null) : void 0 === n ? N(t, i) : e(n) ? function(e, t, i) {
                  s(function(e) {
                      var n = !1
                        , r = function(e, t, i, n) {
                          try {
          ...
          function x(e, t) {
              var i, n;
              e === t ? B(e, new TypeError("You cannot resolve a promise with itself")) : (n = typeof (i = t),
              null === i || "object" !== n && "function" !== n ? N(e, t) : O(e, t, _(t)))
          }
          function M(e) {
          ...
          function L(e) {
              var t = e._subscribers
                , i = e._state;
              if (0 !== t.length) {
                  for (var n = void 0, r = void 0, o = e._result, a = 0; a < t.length; a += 3)
                      n = t[a],
                      r = t[a + i],
                      n ? U(i, n, r, o) : r(o);
          ...
          function U(t, i, n, r) {
              ...
              if (o) {
                  ...
                  a.error = null) : l = !0,
                  i === a)
                      return void B(i, new TypeError("A promises callback cannot return that same promise."))
              } else
                  a = r,
                  l = !0;
          ...
          var R = function() {
              function e(e, t) {
                  ...
                  this._enumerate(t),
                  0 === this._remaining && N(this.promise, this._result))) : B(this.promise, new Error("Array Methods must be provided an Array"))
              }
...
, function(e, t, i) {
  ...
  n = window,
  (a = function() {
      return r = (new (window.UAParser || t.UAParser)).getResult(),
      o = new u,
      this
  }
  ).prototype = {
      ...
      getFlashVersion: function() {
          return this.isFlash() ? (objPlayerVersion = d.getFlashPlayerVersion(),
      ...
      var o = {
          ...
          getJREs: function() {
              ...
              if (this.isPluginInstalled())
                  ...
                  "MSIE" == (i = this.getBrowser()) ? this.testUsingActiveX("1.7.0") ? t[0] = "1.7.0" : this.testUsingActiveX("1.6.0") ? t[0] = "1.6.0" : this.testUsingActiveX("1.5.0") ? t[0] = "1.5.0" : this.testUsingActiveX("1.4.2") ? t[0] = "1.4.2" : this.testForMSVM() && (t[0] = "1.1") : "Netscape Family" == i && (this.getJPIVersionUsingMimeType(),
                  null != this.firefoxJavaVersion ? t[0] = this.firefoxJavaVersion : this.testUsingMimeTypes("1.7") ? t[0] = "1.7.0" : this.testUsingMimeTypes("1.6") ? t[0] = "1.6.0" : this.testUsingMimeTypes("1.5") ? t[0] = "1.5.0" : this.testUsingMimeTypes("1.4.2") ? t[0] = "1.4.2" : "Safari" == this.browserName2 && (this.testUsingPluginsArray("1.7.0") ? t[0] = "1.7.0" : this.testUsingPluginsArray("1.6") ? t[0] = "1.6.0" : this.testUsingPluginsArray("1.5") ? t[0] = "1.5.0" : this.testUsingPluginsArray("1.4.2") && (t[0] = "1.4.2")));
              if (this.debug)
          ...
          isAutoInstallEnabled: function(e) {
              if (!this.isPluginInstalled())
                  return !1;
              if (void 0 === e && (e = null),
              "MSIE" != l.browserName || l.compareVersionToPattern(l.getPlugin().version, ["10", "0", "0"], !1, !0))
                  e = !0;
              else if (null == e)
                  e = !1;
              else {
          ...
          installLatestJRE: function(e) {
              if (this.isPluginInstalled() && this.isAutoInstallEnabled()) {
                  var i = !1;
                  return (i = this.isCallbackSupported() ? this.getPlugin().installLatestJRE(e) : this.getPlugin().installLatestJRE()) && (this.refresh(),
                  null != this.returnPage && (document.location = this.returnPage)),
                  i
              }
              if (e = this.getBrowser(),
              i = navigator.platform.toLowerCase(),
              "true" == this.EAInstallEnabled && -1 != i.indexOf("win") && null != this.EarlyAccessURL)
          ...
          runApplet: function(t, i, n) {
              ...
              null != r ? "?" != this.getBrowser() ? this.versionCheck(n + "+") ? this.writeAppletTag(t, i) : this.installJRE(n + "+") && (this.refresh(),
              location.href = document.location,
              this.writeAppletTag(t, i)) : this.writeAppletTag(t, i) : e("[runApplet()] Invalid minimumVersion argument to runApplet():" + n)
          },
          writeAppletTag: function(e, t) {
              ...
              t)
                  ...
                  "object" != c && "java_object" != c && "java_code" != c || (o = !1),
          ...
          versionCheck: function(t) {
              ...
              if (null != n) {
                  for (var r = t = !1, o = [], a = 1; a < n.length; ++a)
                      "string" == typeof n[a] && "" != n[a] && (o[i] = n[a],
                      i++);
                  for ("+" == o[o.length - 1] ? (r = !0,
                  t = !1,
                  o.length--) : "*" == o[o.length - 1] ? (r = !1,
                  t = !0,
                  o.length--) : 4 > o.length && (r = !1,
                  t = !0),
                  i = this.getJREs(),
                  a = 0; a < i.length; ++a)
                      if (this.compareVersionToPattern(i[a], o, t, r))
                          return !0
              } else
                  e("[versionCheck()] " + (i = "Invalid versionPattern passed to versionCheck: " + t)),
                  alert(i);
              return !1
          },
          isWebStartInstalled: function(t) {
              ...
              var i = !1;
              return null != t.match("^(\\d+)(?:\\.(\\d+)(?:\\.(\\d+)(?:_(\\d+))?)?)?$") ? i = this.versionCheck(t + "+") : (e("[isWebStartInstaller()] Invalid minimumVersion argument to isWebStartInstalled(): " + t),
          ...
          launchWebStartApplication: function(e) {
              ...
              "MSIE" == n ? i = '<object classid="clsid:8AD9C840-044E-11D1-B3E9-00805F499D93" width="0" height="0"><PARAM name="launchjnlp" value="' + e + '"><PARAM name="docbase" value="' + t + '"></object>' : "Netscape Family" == n && (i = '<embed type="application/x-java-applet;jpi-version=' + this.firefoxJavaVersion + '" width="0" height="0" launchjnlp="' + e + '"docbase="' + t + '" />'),
              "undefined" == document.body || null == document.body ? (document.write(i),
          ...
          compareVersionToPattern: function(e, t, i, n) {
              ...
              if (null != r) {
                  ...
                  for (var a = 1; a < r.length; ++a)
                      "string" == typeof r[a] && "" != r[a] && (e[o] = r[a],
                      o++);
                  if (r = Math.min(e.length, t.length),
                  n) {
                      for (a = 0; a < r; ++a) {
                          if (e[a] < t[a])
                              return !1;
          ...
          getBrowser: function() {
              if (null == this.browserName) {
                  ...
                  -1 != t.indexOf("msie") && -1 == t.indexOf("opera") ? this.browserName2 = this.browserName = "MSIE" : -1 != t.indexOf("iphone") ? (this.browserName = "Netscape Family",
                  this.browserName2 = "iPhone") : -1 != t.indexOf("firefox") && -1 == t.indexOf("opera") ? (this.browserName = "Netscape Family",
                  this.browserName2 = "Firefox") : -1 != t.indexOf("chrome") ? (this.browserName = "Netscape Family",
          ...
          testUsingActiveX: function(t) {
              if (t = "JavaWebStart.isInstalled." + t + ".0",
              "undefined" == typeof ActiveXObject || !ActiveXObject)
                  return e("[testUsingActiveX()] Browser claims to be IE, but no ActiveXObject object?"),
                  !1;
              try {
          ...
          testUsingMimeTypes: function(t) {
              if (!navigator.mimeTypes)
                  return e("[testUsingMimeTypes()] Browser claims to be Netscape family, but no mimeTypes[] array?"),
                  !1;
              for (var i = 0; i < navigator.mimeTypes.length; ++i) {
                  s = navigator.mimeTypes[i].type;
                  var n = s.match(/^application\/x-java-applet\x3Bversion=(1\.8|1\.7|1\.6|1\.5|1\.4\.2)$/);
                  if (null != n && this.compareVersions(n[1], t))
                      return !0
              }
              return !1
          },
          ...
          IEInstall: function() {
              return location.href = t((null != this.returnPage ? "&returnPage=" + this.returnPage : "") + (null != this.locale ? "&locale=" + this.locale : "") + (null != this.brand ? "&brand=" + this.brand : "")),
              !1
          },
          done: function(e, t) {},
          FFInstall: function() {
              return location.href = t((null != this.returnPage ? "&returnPage=" + this.returnPage : "") + (null != this.locale ? "&locale=" + this.locale : "") + (null != this.brand ? "&brand=" + this.brand : "") + (null != this.installType ? "&type=" + this.installType : "")),
              !1
          },
  ...
  function c(e, t) {
      ...
      a = 0; a < n; )
          ...
          ++a,
          r = 27492 + (65535 & (r = 5 * (65535 & (r = (r ^= o = 461845907 * (65535 & (o = (o = 3432918353 * (65535 & o) + ((3432918353 * (o >>> 16) & 65535) << 16) & 4294967295) << 15 | o >>> 17)) + ((461845907 * (o >>> 16) & 65535) << 16) & 4294967295) << 13 | r >>> 19)) + ((5 * (r >>> 16) & 65535) << 16) & 4294967295)) + ((58964 + (r >>> 16) & 65535) << 16);
      switch (o = 0,
      i) {
      case 3:
      ...
      ((r = 3266489909 * (65535 & (r ^= r >>> 13)) + ((3266489909 * (r >>> 16) & 65535) << 16) & 4294967295) ^ r >>> 16) >>> 0
  }
  var d = function() {
      function e() {
          if (!x) {
          ...
          if (0 < e)
              for (var t = 0; t < e; t++) {
                  ...
                  if (0 < B.pv[0]) {
                      if (u = h(i))
                          if (!f(I[t].swfVersion) || B.wk && 312 > B.wk)
                              if (I[t].expressInstall && o()) {
                                  ...
                                  u.getAttribute("class") && (l.styleclass = u.getAttribute("class")),
                                  u.getAttribute("align") && (l.align = u.getAttribute("align"));
                                  for (var u, c = {}, d = (u = u.getElementsByTagName("param")).length, p = 0; p < d; p++)
                                      "movie" != u[p].getAttribute("name").toLowerCase() && (c[u[p].getAttribute("name")] = u[p].getAttribute("value"));
                                  a(l, c, i, n)
                              } else
                                  s(u),
                                  n && n(l);
                      ...
                      m(i, !0),
                      n && ((i = r(i)) && void 0 !== i.SetVariable && (l.success = !0,
                      l.ref = i),
                      n(l))
              }
      }
      function r(e) {
          var t = null;
          return (e = h(e)) && "OBJECT" == e.nodeName && (void 0 !== e.SetVariable ? t = e : (e = e.getElementsByTagName("object")[0]) && (t = e)),
          t
      }
      function o() {
      ...
      function a(e, t, i, n) {
          ...
          var r = h(i);
          r && ("OBJECT" == r.nodeName ? (v = l(r),
          y = null) : (v = r,
          y = i),
          e.id = "SWFObjectExprInst",
          (void 0 === e.width || !/%$/.test(e.width) && 310 > parseInt(e.width, 10)) && (e.width = "310"),
          (void 0 === e.height || !/%$/.test(e.height) && 137 > parseInt(e.height, 10)) && (e.height = "137"),
          P.title = P.title.slice(0, 47) + " - Flash Player Installation",
          n = B.ie && B.win ? "ActiveX" : "PlugIn",
          n = "MMredirectURL=" + S.location.toString().replace(/&/g, "%26") + "&MMplayerType=" + n + "&MMdoctitle=" + P.title,
          t.flashvars = void 0 !== t.flashvars ? t.flashvars + "&" + n : n,
          B.ie && B.win && 4 != r.readyState && (i += "SWFObjectNew",
      ...
      function u(e, t, i) {
          ...
          if (r)
              ...
              B.ie && B.win) {
                  ...
                  for (var l in (s = P.createElement("object")).setAttribute("type", "application/x-shockwave-flash"),
                  e)
      ...
      function p(e, t, i, n) {
          if (!B.ie || !B.mac) {
              ...
              n && (E = A = null),
              A && E == i || ((n = P.createElement("style")).setAttribute("type", "text/css"),
              n.setAttribute("media", i),
              A = r.appendChild(n),
              B.ie && B.win && void 0 !== P.styleSheets && 0 < P.styleSheets.length && (A = P.styleSheets[P.styleSheets.length - 1]),
              E = i),
              B.ie && B.win ? A && "object" == typeof A.addRule && A.addRule(e, t) : A && void 0 !== P.createTextNode && A.appendChild(P.createTextNode(e + " {" + t + "}")))
          }
      }
      function m(e, t) {
          if (N) {
      ...
      var v, y, b, w, A, E, S = window, P = document, C = navigator, T = !1, k = [function() {
          T ? function() {
          ...
          !1)
            , o = [0, 0, 0]
            , a = null;
          if (void 0 !== C.plugins && "object" == typeof C.plugins["Shockwave Flash"])
              !(a = C.plugins["Shockwave Flash"].description) || void 0 !== C.mimeTypes && C.mimeTypes["application/x-shockwave-flash"] && !C.mimeTypes["application/x-shockwave-flash"].enabledPlugin || (T = !0,
              r = !1,
      ...
      return B.w3 && ((void 0 !== P.readyState && "complete" == P.readyState || void 0 === P.readyState && (P.getElementsByTagName("body")[0] || P.body)) && e(),
      x || (void 0 !== P.addEventListener && P.addEventListener("DOMContentLoaded", e, !1),
      B.ie && B.win && (P.attachEvent("onreadystatechange", function() {
          "complete" == P.readyState && (P.detachEvent("onreadystatechange", arguments.callee),
          e())
      }),
      S == top && function() {
          if (!x) {
      ...
      }),
      {
          ...
          embedSWF: function(e, i, n, r, s, l, c, d, h, p) {
              ...
              B.w3 && !(B.wk && 312 > B.wk) && e && i && n && r && s ? (m(i, !1),
              t(function() {
                  n += "",
                  r += "";
                  var t = {};
                  ...
                  if (c && "object" == typeof c)
                      for (var b in c)
                          v.flashvars = void 0 !== v.flashvars ? v.flashvars + "&" + b + "=" + c[b] : b + "=" + c[b];
                  if (f(s))
                      y = u(t, v, i),
                      t.id == i && m(i, !0),
                      g.success = !0,
          ...
          expressInstallCallback: function() {
              if (M) {
                  ...
                  y && (m(y, !0),
                  B.ie && B.win && (v.style.display = "block")),
                  b && b(w)),
                  M = !1
              }
          }
  ...
  !function(i, n) {
      var r = {
          extend: function(e, t) {
              for (var i in t)
                  -1 !== "browser cpu device engine os".indexOf(i) && 0 == t[i].length % 2 && (e[i] = t[i].concat(e[i]));
              return e
          },
          has: function(e, t) {
        ...
        , o = function() {
          for (var e, t, i, r, o, a, s, l = 0, u = arguments; l < u.length && !a; ) {
              ...
              if (void 0 === e)
                  for (r in e = {},
                  d)
                      d.hasOwnProperty(r) && ("object" == typeof (o = d[r]) ? e[o[0]] = n : e[o] = n);
              for (t = i = 0; t < c.length && !a; )
                  if (a = c[t++].exec(this.getUA()))
                      for (r = 0; r < d.length; r++)
                          s = a[++i],
                          "object" == typeof (o = d[r]) && 0 < o.length ? 2 == o.length ? e[o[0]] = "function" == typeof o[1] ? o[1].call(this, s) : o[1] : 3 == o.length ? e[o[0]] = "function" != typeof o[1] || o[1].exec && o[1].test ? s ? s.replace(o[1], o[2]) : n : s ? o[1].call(this, s, o[2]) : n : 4 == o.length && (e[o[0]] = s ? o[3].call(this, s.replace(o[1], o[2])) : n) : e[o] = s || n;
              l += 2
          }
          return e
      }
        ...
        , u = function(e, t) {
          ...
          return this.getBrowser = function() {
              ...
              return e.major = r.major(e.version),
              e
          }
          ,
...
, function(e, t, i) {
  ...
  void 0 === (n = window).EmanageCRMJS && (n.EmanageCRMJS = function e() {
      ...
      this.Campaign = new o.default(this.webkey,this.cid,t.baseGetAPIEndpoint),
      this.Order = new a.default(this.webkey,this.cid,this.isTest,t.basePostAPIEndpoint)
  }
  )
}
, function(e, t, i) {
